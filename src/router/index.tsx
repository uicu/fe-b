...
// 统计页-数据概览
const StatOverview = lazy(
  () => import(/* webpackChunkName: "statOverviewPage" */ '../pages/question/Stat/StatOverview')
)
// 统计页-数据概览
const StatDetails = lazy(
  () => import(/* webpackChunkName: "statDetailsPage" */ '../pages/question/Stat/StatDetails')
)
